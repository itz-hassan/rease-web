        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">
             Revolutionize Roads with Rease: Your Power to Build Better Infrastructure
            </h1>
            <p className="text-xl text-gray-200 mb-8" data-aos="fade-up" data-aos-delay="200">
              Welcome to Rease, where every citizen becomes a road infrastructure champion. Join us in transforming Nigeria's federal, state, and local roads into a network of durability and reliability. Together, we can build a better future, one road at a time.
            </p>
